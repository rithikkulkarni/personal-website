...
export function Experience() {
  const experiences: ExperienceItem[] = [
    ...
    },
    {
      ...
      achievements: [
        'Built and deployed a real-time computer vision posture analysis system using Python, MediaPipe, and Next.js, delivering live feedback to 100+ active users',
        'Designed a patent-pending scoring algorithm combining pose estimation, temporal smoothing, and weighted heuristics to generate continuous 0–100 posture scores',
        'Developed a low-latency streaming pipeline and feature extraction system (joint angles, facial alignment), enabling scalable data collection for future ML model training',
        'Defined product strategy, business model, and go-to-market plan alongside one co-founder',
      ],
      technologies: ['Python', 'MediaPipe', 'Next.js', 'TypeScript', 'Computer Vision'],
    },
    {
      ...
      achievements: [
        'Developed a machine learning pipeline in Python (scikit-learn) to detect student wheelspinning behavior in SimStudent, an AI tutoring system that teaches middle school students the basics of algebra',
        'Implemented an ensemble model (Random Forest + Bayesian Knowledge Tracing) that reduced false negative detections by 35%',
        'Processed 2M+ interaction logs using pandas to identify early learning stagnation patterns and improve intervention timing',
      ],
    ...
    },
    {
      ...
      achievements: [
        'Developed an automated lead scoring and qualification pipeline using n8n, Relevance AI, and Python, reducing manual sales workload by 30%',
        'Built data enrichment workflows integrating external APIs to rank and prioritize high-quality leads for sales teams',
      ],
    ...
    },
    {
      ...
      achievements: [
        'Designed and iterated on UI components for an enterprise workflow application in an agile environment, improving usability of data-intensive processes',
        'Conducted usability testing and analyzed user behavior to guide design decisions, increasing System Usability Score from 62 to 79',
        'Collaborated with developers to implement frontend improvements using HTML/CSS/JavaScript, bridging design and engineering workflows',
      ],
